...
- 15 testów API: wszystkie przechodzą.
- 2 scenariusze E2E: przechodzą lokalnie w Microsoft Edge oraz w Chromium na runnerze GitHub Actions.
...
- Uwierzytelnienie prawdziwym kontem Microsoft i MFA wymaga udziału właściciela konta.
